...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting [efgs-opensource@telekom.de](mailto:efgs-opensource@telekom.de) and/or a project maintainer.
...
* If you plan to do something more involved, please reach out to us and send an [email](mailto:efgs-opensource@telekom.de). This will avoid unnecessary work and surely give you and us a good deal of inspiration.
...
* If your patch is not getting reviewed or you need a specific person to review it, you can @-reply a reviewer asking for a review in the pull request or a comment, or you can ask for a review by contacting us via [email](mailto:efgs-opensource@telekom.de).
...
* Please apply one or more applicable [labels](https://github.com/eu-federation-gateway-service/efgs-federation-gateway/labels) to your issue so that all community members are able to cluster the issues better.
